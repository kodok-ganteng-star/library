...
--
-- Host: localhost:3306
-- Generation Time: Oct 16, 2025 at 10:37 PM
...
ALTER TABLE `buku_kategori`
  ...
  ADD CONSTRAINT `kategori-id_kategori` FOREIGN KEY (`id_kategori`) REFERENCES `kategori` (`id_kategori`) ON DELETE RESTRICT ON UPDATE RESTRICT;
